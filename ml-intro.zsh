...
# ipywidgets ipympl sympy pandas networkx pydot xgboost tabulate pickle5 basemap imageio imageio-ffmpeg statsmodels pyvirtualdisplay box2d-py pygame
conda activate ml
conda install -n ml -c conda-forge tqdm
